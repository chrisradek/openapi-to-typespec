export const openapi = {
  ...
  servers: [
    { url: "https://api.weather.gov", description: "Production server" },
  ],
  paths: {
    "/alerts": {
      get: {
        ...
        responses: {
          "200": { $ref: "#/components/responses/AlertCollection" },
          "301": {
            description:
        ...
        responses: {
          "200": {
            ...
            headers: {
              ...
              "X-Server-Id": { $ref: "#/components/headers/ServerId" },
            },
            content: {
              "application/ld+json": {
                schema: {
    ...
    "/alerts/active/zone/{zoneId}": {
      ...
      parameters: [{ $ref: "#/components/parameters/NWSZoneId" }],
    },
      ...
      parameters: [
        {
          ...
          required: true,
          schema: { $ref: "#/components/schemas/MarineRegionCode" },
        },
      ],
    },
    "/alerts/types": {
          ...
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/AlertGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/AlertJsonLd" },
              },
              "application/cap+xml": {
                schema: { $ref: "#/components/schemas/AlertCap" },
              },
            },
      ...
      parameters: [
        {
          ...
          required: true,
          schema: { $ref: "#/components/schemas/AlertId" },
        },
      ],
    },
      ...
      get: {
        ...
        parameters: [
          ...
          { $ref: "#/components/parameters/Date" },
          {
            ...
            required: true,
            schema: { minimum: 100, type: "integer" },
          },
        ],
        responses: {
          "200": {
            ...
            content: {
              ...
              "application/vnd.noaa.uswx+xml": { schema: {} },
            },
          },
          default: { $ref: "#/components/responses/Error" },
        },
      ...
      get: {
        ...
        parameters: [
          ...
          { $ref: "#/components/parameters/QueryDate" },
          {
            ...
            schema: { $ref: "#/components/schemas/ATSUIdentifier" },
          },
          {
            name: "sequence",
            in: "query",
            description: "SIGMET sequence number",
            schema: { $ref: "#/components/schemas/SigmetSequenceNumber" },
          },
        ],
        responses: {
          "200": {
    ...
    "/aviation/sigmets/{atsu}": {
      get: {
        ...
        parameters: [{ $ref: "#/components/parameters/ATSUIdentifier" }],
        responses: {
          "200": {
            description: "success",
            content: {
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/SigmetGeoJson" },
              },
              "application/vnd.noaa.uswx+xml": { schema: {} },
            },
          },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/GridpointGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/GridpointJsonLd" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
    ...
    "/gridpoints/{wfo}/{x},{y}/forecast": {
      get: {
        ...
        responses: {
          "200": { $ref: "#/components/responses/GridpointForecast" },
          default: { $ref: "#/components/responses/Error" },
        },
      },
      parameters: [
    ...
    "/icons/{set}/{timeOfDay}/{first}": {
      ...
      parameters: [
        ...
        },
        {
          ...
          schema: {
            anyOf: [
              { enum: ["small", "medium", "large"], type: "string" },
              { maximum: 500, minimum: 10, type: "integer" },
            ],
          },
        },
        {
          ...
          in: "query",
          description: "Font size",
          schema: { maximum: 24, minimum: 2, type: "integer" },
        },
      ],
    },
      ...
      parameters: [
        {
          ...
          description: ".",
          required: true,
          schema: { enum: ["a", "e", "g", "h", "p", "s", "w"], type: "string" },
        },
      ],
    },
    "/stations/{stationId}/observations": {
      get: {
        ...
        responses: {
          "200": { $ref: "#/components/responses/ObservationCollection" },
          default: { $ref: "#/components/responses/Error" },
        },
      },
      parameters: [{ $ref: "#/components/parameters/ObservationStationId" }],
    },
    ...
    "/stations/{stationId}/tafs/{date}/{time}": {
      get: {
        ...
        responses: {
          "200": {
            description: "success",
            content: { "application/vnd.wmo.iwxxm+xml": { schema: {} } },
          },
          default: { $ref: "#/components/responses/Error" },
        },
      },
    ...
    "/offices/{officeId}": {
      ...
      parameters: [{ $ref: "#/components/parameters/NWSOfficeId" }],
    },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/OfficeHeadline" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/PointGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/PointJsonLd" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
    ...
    "/points/{point}/stations": {
      get: {
        ...
        responses: {
          "301": { description: "redirect to gridpoint stations" },
          default: { $ref: "#/components/responses/Error" },
        },
        deprecated: true,
        parameters: [],
        ...
        parameters: [
          {
            ...
            schema: {
              type: "array",
              items: { pattern: "^[A-Za-z0-9-]+$", type: "string" },
            },
          },
          {
            name: "reportingHost",
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: { $ref: "#/components/schemas/ISO8601Interval" },
          },
          {
            name: "created",
            in: "query",
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: { $ref: "#/components/schemas/ISO8601Duration" },
          },
        ],
        responses: {
          "200": {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            schema: {
              type: "array",
              items: { pattern: "^[A-Z]{4}$", type: "string" },
            },
          },
          {
            name: "wmoid",
            ...
            schema: {
              type: "array",
              items: { pattern: "^[A-Z]{4}\\d{2}$", type: "string" },
            },
          },
          {
            name: "type",
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/TextProductCollection" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/TextProduct" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
      ...
      get: {
        ...
        parameters: [
          {
            ...
            schema: {
              type: "array",
              items: { $ref: "#/components/schemas/NWSZoneID" },
            },
          },
          {
            name: "area",
          ...
          },
          {
            ...
            schema: {
              type: "array",
              items: { $ref: "#/components/schemas/RegionCode" },
            },
          },
          {
            name: "type",
            ...
            schema: {
              type: "array",
              items: { $ref: "#/components/schemas/NWSZoneType" },
            },
          },
          {
            name: "point",
            ...
            schema: { $ref: "#/components/schemas/PointString" },
          },
          {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/ZoneCollectionGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/ZoneCollectionJsonLd" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
      ...
      parameters: [
        {
          ...
          description: "Zone type",
          required: true,
          schema: { $ref: "#/components/schemas/NWSZoneType" },
        },
      ],
    },
    "/zones/{type}/{zoneId}": {
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/ZoneGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/ZoneJsonLd" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/geo+json": {
                schema: { $ref: "#/components/schemas/ZoneForecastGeoJson" },
              },
              "application/ld+json": {
                schema: { $ref: "#/components/schemas/ZoneForecastJsonLd" },
              },
            },
          },
          default: { $ref: "#/components/responses/Error" },
  ...
  components: {
    schemas: {
      Alert: {
        type: "object",
        properties: {
          id: { $ref: "#/components/schemas/AlertId" },
          areaDesc: {
            type: "string",
            description:
          ...
          references: {
            ...
            items: {
              ...
              properties: {
                ...
                identifier: { $ref: "#/components/schemas/AlertId" },
                sender: {
                  type: "string",
          ...
          messageType: { $ref: "#/components/schemas/AlertMessageType" },
          category: {
            enum: [
              "Met",
              "Geo",
            ...
            properties: {
              features: {
                ...
                items: {
                  type: "object",
                  properties: {
                    properties: { $ref: "#/components/schemas/Alert" },
                  },
                },
              },
            },
      ...
      AlertCap: { type: "object" },
      AlertGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: { properties: { $ref: "#/components/schemas/Alert" } },
          },
        ],
      },
      AlertJsonLd: {
      ...
      AlertAtomEntry: {
        ...
        properties: {
          ...
          geocode: {
            type: "array",
            items: { $ref: "#/components/schemas/AlertXMLParameter" },
            xml: { namespace: "urn:oasis:names:tc:emergency:cap:1.2" },
          },
          parameter: {
            type: "array",
      ...
      AlertAtomFeed: {
        ...
        properties: {
          ...
          entry: {
            type: "array",
            items: { $ref: "#/components/schemas/AlertAtomEntry" },
            xml: { namespace: "http://www.w3.org/2005/Atom" },
          },
        },
      ...
      CenterWeatherAdvisory: {
        ...
        properties: {
          ...
          cwsu: { $ref: "#/components/schemas/NWSCenterWeatherServiceUnitId" },
          sequence: { minimum: 101, type: "integer" },
      ...
      CenterWeatherServiceUnitJsonLd: { $ref: "#/components/schemas/Office" },
      Date: {
        type: "string",
        ...
        oneOf: [
          {
            ...
            properties: {
              ...
              coordinates: { $ref: "#/components/schemas/GeoJsonCoordinate" },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
          {
            ...
            type: "object",
            properties: {
              type: { enum: ["LineString"], type: "string" },
              coordinates: { $ref: "#/components/schemas/GeoJsonLineString" },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
          {
            ...
            properties: {
              ...
              coordinates: { $ref: "#/components/schemas/GeoJsonPolygon" },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
          {
            ...
            type: "object",
            properties: {
              type: { enum: ["MultiPoint"], type: "string" },
              coordinates: {
                type: "array",
                items: { $ref: "#/components/schemas/GeoJsonCoordinate" },
              },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
          {
            ...
            type: "object",
            properties: {
              type: { enum: ["MultiLineString"], type: "string" },
              coordinates: {
                type: "array",
                items: { $ref: "#/components/schemas/GeoJsonLineString" },
              },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
          {
            ...
            properties: {
              ...
              coordinates: {
                type: "array",
                items: { $ref: "#/components/schemas/GeoJsonPolygon" },
              },
              bbox: { $ref: "#/components/schemas/GeoJsonBoundingBox" },
            },
          },
      ...
      Gridpoint: {
        ...
        properties: {
          "@context": { $ref: "#/components/schemas/JsonLdContext" },
          geometry: { $ref: "#/components/schemas/GeometryString" },
          "@id": { type: "string", format: "uri" },
          "@type": { enum: ["wx:Gridpoint"], type: "string" },
          updateTime: { type: "string", format: "date-time" },
          validTimes: { $ref: "#/components/schemas/ISO8601Interval" },
          elevation: { $ref: "#/components/schemas/QuantitativeValue" },
          forecastOffice: { type: "string", format: "uri" },
          gridId: { type: "string" },
          gridX: { minimum: 0, type: "integer" },
          gridY: { minimum: 0, type: "integer" },
          weather: {
            required: ["values"],
            type: "object",
            properties: {
              values: {
                ...
                items: {
                  ...
                  type: "object",
                  properties: {
                    validTime: { $ref: "#/components/schemas/ISO8601Interval" },
                    value: {
                      type: "array",
                      items: {
                        required: [
      ...
      GridpointQuantitativeValueLayer: {
        ...
        type: "object",
        properties: {
          uom: { $ref: "#/components/schemas/UnitOfMeasure" },
          values: {
            type: "array",
            items: {
              required: ["validTime", "value"],
      ...
      GridpointGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: {
              properties: { $ref: "#/components/schemas/Gridpoint" },
            },
          },
        ],
      },
      ...
      GridpointForecast: {
        ...
        properties: {
          "@context": { $ref: "#/components/schemas/JsonLdContext" },
          geometry: { $ref: "#/components/schemas/GeometryString" },
          units: { $ref: "#/components/schemas/GridpointForecastUnits" },
          forecastGenerator: {
            type: "string",
            description:
          ...
          periods: {
            type: "array",
            items: { $ref: "#/components/schemas/GridpointForecastPeriod" },
      ...
      GridpointForecastPeriod: {
        ...
        properties: {
          ...
          dewpoint: { $ref: "#/components/schemas/QuantitativeValue" },
          relativeHumidity: { $ref: "#/components/schemas/QuantitativeValue" },
          windSpeed: {
            oneOf: [
              { $ref: "#/components/schemas/QuantitativeValue" },
              { type: "string" },
      ...
      GridpointForecastGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: {
              properties: { $ref: "#/components/schemas/GridpointForecast" },
            },
          },
        ],
      },
      ...
      Observation: {
        ...
        properties: {
          ...
          geometry: { $ref: "#/components/schemas/GeometryString" },
          "@id": { type: "string", format: "uri" },
          "@type": { enum: ["wx:ObservationStation"], type: "string" },
          elevation: { $ref: "#/components/schemas/QuantitativeValue" },
          station: { type: "string", format: "uri" },
          ...
          presentWeather: {
            type: "array",
            items: { $ref: "#/components/schemas/MetarPhenomenon" },
          },
          temperature: { $ref: "#/components/schemas/QuantitativeValue" },
          dewpoint: { $ref: "#/components/schemas/QuantitativeValue" },
          windDirection: { $ref: "#/components/schemas/QuantitativeValue" },
          windSpeed: { $ref: "#/components/schemas/QuantitativeValue" },
          windGust: { $ref: "#/components/schemas/QuantitativeValue" },
          barometricPressure: {
            $ref: "#/components/schemas/QuantitativeValue",
          },
          seaLevelPressure: { $ref: "#/components/schemas/QuantitativeValue" },
          ...
          relativeHumidity: { $ref: "#/components/schemas/QuantitativeValue" },
          windChill: { $ref: "#/components/schemas/QuantitativeValue" },
          heatIndex: { $ref: "#/components/schemas/QuantitativeValue" },
          cloudLayers: {
            type: "array",
            items: {
              ...
              type: "object",
              properties: {
                base: { $ref: "#/components/schemas/QuantitativeValue" },
                amount: { $ref: "#/components/schemas/MetarSkyCoverage" },
              },
              additionalProperties: false,
            },
            nullable: true,
      ...
      ObservationGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: {
              properties: { $ref: "#/components/schemas/Observation" },
            },
          },
        ],
      },
      ObservationJsonLd: { $ref: "#/components/schemas/Observation" },
      ...
      ObservationStation: {
        ...
        properties: {
          ...
          name: { type: "string" },
          timeZone: { type: "string", format: "iana-time-zone-identifier" },
          forecast: {
            type: "string",
            description:
      ...
      ObservationStationCollectionJsonLd: {
        ...
        properties: {
          ...
          "@graph": {
            type: "array",
            items: { $ref: "#/components/schemas/ObservationStation" },
          },
          observationStations: {
            type: "array",
            items: { type: "string", format: "uri" },
      ...
      Office: {
        ...
        properties: {
          "@context": { $ref: "#/components/schemas/JsonLdContext" },
          "@type": { enum: ["GovernmentOrganization"], type: "string" },
          "@id": { type: "string", format: "uri" },
          id: { type: "string" },
          name: { type: "string" },
          address: {
            type: "object",
            properties: {
              "@type": { enum: ["PostalAddress"], type: "string" },
          ...
          nwsRegion: { type: "string" },
          parentOrganization: { type: "string", format: "uri" },
          responsibleCounties: {
            type: "array",
            items: { type: "string", format: "uri" },
          },
      ...
      OfficeHeadline: {
        ...
        properties: {
          ...
          "@id": { type: "string", format: "uri" },
          id: { type: "string" },
          office: { type: "string", format: "uri" },
          important: { type: "boolean" },
          issuanceTime: { type: "string", format: "date-time" },
      ...
      OfficeHeadlineCollection: {
        ...
        properties: {
          ...
          "@graph": {
            type: "array",
            items: { $ref: "#/components/schemas/OfficeHeadline" },
          },
        },
        additionalProperties: false,
      },
      ...
      Point: {
        ...
        properties: {
          ...
          geometry: { $ref: "#/components/schemas/GeometryString" },
          "@id": { type: "string", format: "uri" },
          "@type": { enum: ["wx:Point"], type: "string" },
          cwa: { $ref: "#/components/schemas/NWSForecastOfficeId" },
          forecastOffice: { type: "string", format: "uri" },
          gridId: { $ref: "#/components/schemas/NWSForecastOfficeId" },
          gridX: { minimum: 0, type: "integer" },
          gridY: { minimum: 0, type: "integer" },
          forecast: { type: "string", format: "uri" },
          forecastHourly: { type: "string", format: "uri" },
          forecastGridData: { type: "string", format: "uri" },
          observationStations: { type: "string", format: "uri" },
          relativeLocation: {
            oneOf: [
          ...
          forecastZone: { type: "string", format: "uri" },
      ...
      PointGeoJson: {
        allOf: [
          ...
          {
            type: "object",
            properties: { properties: { $ref: "#/components/schemas/Point" } },
          },
        ],
      },
      PointJsonLd: {
      ...
      QuantitativeValue: {
        ...
        properties: {
          ...
          unitCode: { $ref: "#/components/schemas/UnitOfMeasure" },
          qualityControl: {
      ...
      RelativeLocation: {
        ...
        properties: {
          city: { type: "string" },
          state: { type: "string" },
          distance: { $ref: "#/components/schemas/QuantitativeValue" },
          bearing: { $ref: "#/components/schemas/QuantitativeValue" },
        },
      },
      RelativeLocationGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: {
              properties: { $ref: "#/components/schemas/RelativeLocation" },
            },
          },
        ],
      },
      ...
      Sigmet: {
        ...
        properties: {
          ...
          atsu: { $ref: "#/components/schemas/ATSUIdentifier" },
        ...
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeatureCollection" },
          {
            ...
            properties: {
              features: {
                type: "array",
                items: { $ref: "#/components/schemas/SigmetGeoJson" },
              },
            },
          },
        ],
      ...
      SigmetGeoJson: {
        allOf: [
          ...
          {
            type: "object",
            properties: { properties: { $ref: "#/components/schemas/Sigmet" } },
          },
        ],
      },
      SigmetSequenceNumber: { type: "string" },
      StateTerritoryCode: {
        enum: [
          "AL",
          "AK",
      ...
      TextProductCollection: {
        ...
        properties: {
          ...
          "@graph": {
            type: "array",
            items: { $ref: "#/components/schemas/TextProduct" },
          },
        },
        additionalProperties: false,
      },
      ...
      Zone: {
        ...
        properties: {
          ...
          geometry: { $ref: "#/components/schemas/GeometryString" },
          "@id": { type: "string", format: "uri" },
          "@type": { enum: ["wx:Zone"], type: "string" },
          id: { $ref: "#/components/schemas/NWSZoneID" },
          type: { $ref: "#/components/schemas/NWSZoneType" },
          name: { type: "string" },
          ...
          forecastOffice: { type: "string", format: "uri" },
          gridIdentifier: { type: "string" },
          awipsLocationIdentifier: { type: "string" },
          cwa: {
            type: "array",
            items: { $ref: "#/components/schemas/NWSForecastOfficeId" },
            deprecated: true,
          },
          forecastOffices: {
            type: "array",
          ...
          timeZone: {
            type: "array",
            items: { type: "string", format: "iana-time-zone-identifier" },
          },
          observationStations: {
            type: "array",
            items: { type: "string", format: "uri" },
          },
          radarStation: { type: "string", nullable: true },
        },
        additionalProperties: false,
      },
      ZoneGeoJson: {
        allOf: [
          ...
          {
            type: "object",
            properties: { properties: { $ref: "#/components/schemas/Zone" } },
          },
        ],
      },
      ZoneJsonLd: { $ref: "#/components/schemas/Zone" },
            ...
            properties: {
              features: {
                ...
                items: {
                  type: "object",
                  properties: {
                    properties: { $ref: "#/components/schemas/Zone" },
                  },
                },
              },
            },
      ...
      ZoneForecastGeoJson: {
        allOf: [
          { $ref: "#/components/schemas/GeoJsonFeature" },
          {
            type: "object",
            properties: {
              properties: { $ref: "#/components/schemas/ZoneForecast" },
            },
          },
        ],
      },
      ZoneForecastJsonLd: { $ref: "#/components/schemas/ZoneForecast" },
    },
    responses: {
      AlertCollection: {
        ...
        content: {
          "application/geo+json": {
            schema: { $ref: "#/components/schemas/AlertCollectionGeoJson" },
          },
          "application/ld+json": {
            schema: { $ref: "#/components/schemas/AlertCollectionJsonLd" },
          },
          "application/atom+xml": {
            schema: { $ref: "#/components/schemas/AlertAtomFeed" },
          },
        },
        "x-url-content-negotiation-extensions": {
          json: "application/geo+json",
      ...
      GridpointForecast: {
        ...
        content: {
          "application/geo+json": {
            schema: { $ref: "#/components/schemas/GridpointForecastGeoJson" },
          },
          "application/ld+json": {
            schema: { $ref: "#/components/schemas/GridpointForecastJsonLd" },
          },
          "application/vnd.noaa.dwml+xml": { schema: {} },
        },
      },
      Observation: {
        ...
        content: {
          "application/geo+json": {
            schema: { $ref: "#/components/schemas/ObservationGeoJson" },
          },
          "application/ld+json": {
            schema: { $ref: "#/components/schemas/ObservationJsonLd" },
          },
          "application/vnd.noaa.uswx+xml": { schema: {} },
          "application/vnd.noaa.obs+xml": { schema: {} },
        },
      },
    ...
    parameters: {
      ...
      AlertMessageType: {
        ...
        schema: {
          type: "array",
          items: { enum: ["alert", "update", "cancel"], type: "string" },
        },
      },
      AlertPoint: {
        name: "point",
      ...
      AlertRegion: {
        ...
        schema: {
          type: "array",
          items: { $ref: "#/components/schemas/MarineRegionCode" },
        },
      },
      AlertRegionType: {
        name: "region_type",
        ...
        schema: { enum: ["land", "marine"], type: "string" },
      },
      AlertSeverity: {
        name: "severity",
        in: "query",
      ...
      GridpointForecastUnits: {
        ...
        schema: { $ref: "#/components/schemas/GridpointForecastUnits" },
      },
      GridpointWFO: {
        name: "wfo",
        in: "path",
        ...
        required: true,
        schema: { $ref: "#/components/schemas/NWSForecastOfficeId" },
      },
      GridpointX: {
        name: "x",
        in: "path",
      ...
      Limit: {
        ...
        in: "query",
        description: "Limit",
        schema: { maximum: 500, minimum: 1, type: "integer", default: 500 },
      },
      NWSCenterWeatherServiceUnitId: {
        name: "cwsuId",
        in: "path",
        ...
        required: true,
        schema: { $ref: "#/components/schemas/NWSCenterWeatherServiceUnitId" },
      },
      NWSOfficeId: {
        name: "officeId",
        in: "path",
        ...
        required: true,
        schema: { $ref: "#/components/schemas/NWSOfficeId" },
      },
      NWSZoneId: {
        name: "zoneId",
        in: "path",
        ...
        required: true,
        schema: { $ref: "#/components/schemas/NWSZoneID" },
      },

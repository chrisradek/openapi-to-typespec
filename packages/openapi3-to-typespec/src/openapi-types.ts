...
export type JsonSchema<AdditionalVocabularies extends {} = {}> =
  AdditionalVocabularies & {
    ...
    properties?: Record<
      string,
      | Refable<JsonSchema<AdditionalVocabularies>>
      | JsonSchema<AdditionalVocabularies>
    >;
...
export type OpenAPI3StatusCode =
  | string
  | "default"
  | "1XX"
  | "2XX"
 ...
 */
export interface OpenAPI3ApiKeySecurityScheme
 ...
 */
export interface OpenAPI3OAuth2SecurityScheme
  extends OpenAPI3SecuritySchemeBase {
  /* OAuth2 */
  type: "oauth2";
...
export interface OpenAPI3OpenIdConnectSecurityScheme
  extends OpenAPI3SecuritySchemeBase {
  /** OpenID Connect */
  type: "openIdConnect";
...
export interface OpenAPIComponents3_1 extends Extensions {
  schemas?: Record<string, Refable<OpenAPISchema3_1>>;
...
} & { parameters?: Refable<OpenAPI3Parameter>[] } & Extensions;
...
export interface OpenAPIDocument3_1 extends Extensions {
  ...
  paths: Record<string, Refable<OpenAPI3PathItem>>;
